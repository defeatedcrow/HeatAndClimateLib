#### Heat&Climate Lib 3.9.3 for Minecraft 1.12.2 ####
...
○3.9.3
　変更
　　・コマンドによる季節の固定が、再起動後も継続するようにした
　修正
　　・耕地がWETで湿る際の動作を修正
　　・TileEntityの更新パケットの動作を修正
　　・湿度ダメージの量と耐性条件を修正
...
　修正
　　・EntityUpdateIntervalコンフィグが正常に機能しない
